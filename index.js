...
export const applyCustomCode = async (externalCodeSetup) => {
  const blockli_config = {
    license: "7DL0IORJK3QUXRF", // Enter your 15 digit Blockli App Kit license key here. See your account dashboard at https://blockli.dev/dashboard
    app_id: config.app_id,
    code: externalCodeSetup,
    website: "https://partners.cardiometabology.com", // Enter your app domain here with NO trailing slash.
